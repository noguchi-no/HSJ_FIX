...
public class TitleManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sequence.Append(titleTextRectTransform1.DOLocalJump(jumpDestination, jumpPower, 1, jumpDuration).SetEase(easeType))
                .Append(titleTextRectTransform2.DOLocalJump(jumpDestination, jumpPower * 1.3f, 1, jumpDuration).SetEase(easeType))
                .Append(titleTextRectTransform3.DOLocalJump(jumpDestination, jumpPower*2f, 1, jumpDuration).SetEase(easeType))
                .SetLoops(-1);
    }
}
